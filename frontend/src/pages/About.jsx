    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          <p>Welcome to BookMyChef, your kitchen's trusted partner. Our state-of-the-art storage solutions ensure that your ingredients stay fresh and secure, preserving quality and taste for every culinary creation.</p>
          <p>With BookMyChef, savor the confidence of knowing your ingredients are always at their best, ready to inspire your next culinary masterpiece.</p>
